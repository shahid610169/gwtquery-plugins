[GwtQuery ](http://code.google.com/p/gwtquery/) is a jQuery-like API written in GWT, which allows GWT to be used in progressive enhancement scenarios where perhaps GWT widgets are too heavyweight.
